            ...
            modelBuilder.Entity("Logistic_Order.Model.Entities.Payment", b =>
                {
                    ...
                    b.Property<int>("TotalCostsCost_Id")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Logistic_Order.Model.Entities.Payment", b =>
                {
                    ...
                    b.HasOne("Logistic_Order.Model.Entities.TotalCost", "TotalCosts")
                        .WithMany()
                        .HasForeignKey("TotalCostsCost_Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
